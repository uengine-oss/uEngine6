        ...
        methods: {
            ...
            verification: function () {
                ...
                if (this.command == 'sign-up-verification') {
                    me.keycloak.signUpVerification(me.$route.query.token)
                        .done(function (User) {
                            //Validate for user...
                            console.log(User);

                            //Compete signup
                            me.keycloak.signUpAccept(me.$route.query.token)
                                .done(function (User) {
                ...
                if (this.command == 'forgot-verification') {
                    me.keycloak.forgotPasswordVerification(me.$route.query.token)
                        .done(function (User) {
                            //Validate for user...
                            console.log(User);
            ...
            editPassword: function (e) {
                ...
                //Compete repassword
                me.keycloak.forgotPasswordAccept(me.$route.query.token, me.$route.query.userName)
                    .done(function (User) {
            ...
            forgot: function (e) {
                e.preventDefault();
                var me = this;
                me.keycloak.forgotPassword(me.myUrl + '/auth/forgot-verification', me.username)
                    .done(function () {
                        //비밀번호 변경 신청 성공 후 알림
            ...
            signup: function (e) {
                e.preventDefault();
                var me = this;
                me.keycloak.signUp(me.myUrl + '/auth/sign-up-verification', {
            ...
            login: function (e) {
                e.preventDefault();
                var me = this;
                me.keycloak.passwordCredentialsLogin(me.username, me.password, me.scope, 'JWT')
