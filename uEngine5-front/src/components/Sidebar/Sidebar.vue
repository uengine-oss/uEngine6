        ...
        data() {
            return {
                items: [
                    ...
                    // { title: '산출물', icon: 'mdi-file-document', link: '/documentation'},
                    {divider: true},
                    {heading: '프로세스'},
                    {
                        title: '참여중',
                        icon: 'mdi-grid-large',
                        link: '/participating/workLists'
                    },
                    {
                        title: '내가 시작한',
                        icon: 'mdi-apps',
                    ...
                    {divider: true},
                    {heading: '통계/분석'},
                    {title: '기본 통계', icon: 'mdi-book-variant-multiple', link: '/charts/overview'},
                    {title: '다차원 분석', icon: 'mdi-forum'},
                    {title: 'EIP', icon: 'mdi-help-circle-outline',},
                    {divider: true},
                    {heading: 'PROJECTS'},
