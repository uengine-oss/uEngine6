    ...
    <div>
        ...
        >
            ...
            <div v-for="relation in data.definition.sequenceFlows">
                <bpmn-relation v-if="relation != null" :relation.sync="relation"
        ...
        <!-- 프로세스 변수 -->
        <!--    md-open-from="#processVariables" md-close-to="#processVariables"-->
        <v-dialog
          ...
          <v-card>
            ...
            <v-card-actions>
              <v-btn class="md-primary" @click="closeProcessVariables">Close</v-btn>
            </v-card-actions>
          </v-card>

<!--            <v-dialog-title>Process Variables</v-dialog-title>-->
<!--            <v-dialog-content>-->
<!--                <object-grid java="org.uengine.kernel.ProcessVariable" :online="false" v-model="processVariables"-->
<!--                             :full-fledged="true" :backend="backend">-->
<!--                </object-grid>-->
            ...
            <v-card>
                ...
                <v-card-text>
                    <v-form novalidate @submit.stop.prevent="submit">
                        <v-container>
                            Description
                            <v-text-field v-model="defintionSettings.shortDescription.text"></v-text-field>
                        </v-container>
                        <v-container>
                            Instance Name Pattern
                            <v-text-field v-model="data.definition.instanceNamePattern"></v-text-field>
                        </v-container>
                        ...
                        <v-switch v-model="data.definition.volatile" id="my-test1" name="my-test1" class="md-primary"
                                  label=" Volatile">
                            Volatile
                        </v-switch>
                ...
                <v-dialog-actions>
                    <v-btn class="md-primary" @click="closeDefinitionSettings">Close</v-btn>
                </v-dialog-actions>
            </v-card>
            <!--          -->
            <!--            <v-dialog-title>Definition Settings</v-dialog-title>-->
            <!--            <v-dialog-content>-->
