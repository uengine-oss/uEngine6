 ...
 * @version $Id: HumanApprovalLineActivity.java,v 1.1 2012/02/13 05:29:12
 *          sleepphoenix4 Exp $
...
public class HumanApprovalLineActivity extends ScopeActivity {
	...
	// fd.setInputter(new RadioInput(new String[]{"Auto","Loop","Finish"}, new
	// Integer[]{HumanApprovalLineActivity.LOOPINGOPTION_AUTO,
	// HumanApprovalLineActivity.LOOPINGOPTION_REPEATONREJECT,
	// HumanApprovalLineActivity.LOOPINGOPTION_FINISHONREJECT}));
	// //fd.setDisplayName("");
	...
	public HumanApprovalLineActivity() {
		...
		draftActivity.setName(GlobalContext
				.getLocalizedMessage("activitytypes.org.uengine.kernel.HumanApprovalActivity.draft.message", "Draft"));
	...
	public void addApprovalActivity(ProcessInstance instance, String approveType, String activityName,
			String approverEndpoint) throws Exception {
		...
		humanApprovalActivity.setRole((Role) null);
