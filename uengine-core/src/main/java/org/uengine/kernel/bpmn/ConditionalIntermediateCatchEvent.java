 ...
 */
public class ConditionalIntermediateCatchEvent extends ConditionalEvent implements NeedArrangementToSerialize {
    public ConditionalIntermediateCatchEvent() {
        super();
        // setExpression("5");
        // setScheduleType("sec");
    }
    ...
    public void afterDeserialization() {
        ...
        if (getPollingIntervalInSecond() == 0)
            setPollingIntervalInSecond(5);
