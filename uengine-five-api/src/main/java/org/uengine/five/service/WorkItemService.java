...
public interface WorkItemService {
    ...
    public RepresentationModel getWorkItem(@PathVariable("taskId") String taskId) throws Exception;

    @RequestMapping(value = "/work-item/{taskId}", method = RequestMethod.POST)
    public void putWorkItem(@PathVariable("taskId") String taskId, @RequestBody RepresentationModel workItem) throws Exception;
